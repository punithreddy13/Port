...
**Direction control:** the engine trades both sides by default. Use `--long-only`
(spot-friendly) or `--short-only` to restrict; in Pine use the *Allow longs* /
*Allow shorts* toggles.
